...
class NewCampaignForm extends React.Component {
  ...
  handleSubmit = async (values, { setSubmitting }) => {
    ...
    const leads = recipientsFromTextInput.concat(recipientsFromFileInput).filter(e => !!e);
    ...
    try {
      ...
      else if (e.message === 'TOKEN_EXPIRED') msg = `Your token has expired. Please log in again.`;
        ...
        {({
          ...
          setFieldValue,
            ...
            <form onSubmit={handleSubmit}>
              ...
              {errors.recipients ?
                <div className="input-feedback" style={{ color: 'red', fontSize: '10px', margin: '5px 0' }}>
                  {errors.recipients}
                </div> :
                null}
              ...
              {this.state.success ?
                <div className="input-feedback" style={{ color: 'green', fontSize: '10px', margin: '5px 0' }}>
                  {this.state.success}
                </div> :
                this.state.error ?
                  <div className="input-feedback" style={{ color: 'red', fontSize: '10px', margin: '5px 0' }}>
